...
/-!
# Boundary charge for dominant labels

Prime density makes the boundary Peierls floor positive and eventually large
enough to pay for every noninitial dominant-label window.
-/
...
-/
private lemma Pifloor_charge_lower (e0 : ℝ) (he0 : 0 < e0) :
