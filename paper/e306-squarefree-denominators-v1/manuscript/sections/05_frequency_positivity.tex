...
VI & \mbox{noncoherent decoded}\newline \mbox{assignment, or a}\newline \mbox{nondecoder row tuple} & anchor counting\newline and fibre error \\
\bottomrule
\end{tabular}
\end{center}
...
For Range~V, the anchor factor and \cref{eq:anchor-exact-energy} give
\[
