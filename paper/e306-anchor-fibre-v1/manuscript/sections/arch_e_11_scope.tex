...
The fixed-ratio robustness in \cref{prop:fixed-ratio-anchor} removes the literal dyadic normalization from the anchor block.  It keeps $\eta\in(0,1)$ fixed and bounded away from the endpoints; it does not assert a shrinking terminal width, a thin-anchor exponent theorem or a second anchor mechanism.
