...
\frac{|H_{pq}(a_p,w')|}{pq}.
\]
After squaring and summing over $p\in F$, Lemma \ref{lem:reciprocal-dispersion} prevents both energies from satisfying \eqref{eq:4.29} when $g$ is sufficiently small.
\end{proof}
