...
\end{equation}
For the parameterized semiprime family this is $\theta=t/\Lambda$, where $\Lambda$ is the total reciprocal load.  The numerator $a$ affects only the target character in \cref{eq:reciprocal-fourier}; the CRT rows which observe the target depend only on the prime divisors of $b$.
