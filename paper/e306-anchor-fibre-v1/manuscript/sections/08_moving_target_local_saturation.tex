...
By \eqref{2.9} and \eqref{2.10}, the fixed centre $t$ lies a positive distance from both endpoints of the eventual interval $[0,\Lambda]$. Since $\sigma\to0$, for each fixed $U$ all targets $t_j$ with \eqref{8.6} lie in $[0,\Lambda]$ for sufficiently large $X$. Lemma \ref{lem:no-wrap} therefore gives
\[
