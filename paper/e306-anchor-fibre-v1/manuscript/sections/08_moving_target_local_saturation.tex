...
\tag{8.7}
\]
On a genuine integer frequency $m$, equations \eqref{6.10} and \eqref{8.4} give, uniformly for $|m|\le C/\sigma$,
\[
F_j(m)
=
\exp\left(
...
Dividing \eqref{8.15} by the central local limit also gives
\[
