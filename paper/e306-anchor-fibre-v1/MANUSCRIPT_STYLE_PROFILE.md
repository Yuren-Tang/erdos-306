...
- Text: TeX Gyre Pagella, loaded by OpenType filename.
...
- Font lookup in the arXiv-facing source uses TeX Live filenames rather than operating-system font names.
...
- The dedication is exactly
  ...
  and is set in GFS Porson from the TeX Live font file `GFSPorson.otf`.
...
- ORCID is displayed visibly and unobtrusively immediately with the author identity, linked to `https://orcid.org/0009-0006-0847-3330`; it is not relegated solely to an end address or hidden metadata.
