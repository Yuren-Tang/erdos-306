...
- **Publication state:** authorial theorem-scope candidate; independent mathematical/source review required before a new external-review or submission checkpoint.
...
The theorem-scope rewrite is fixed at
...
The rewrite changes `main.tex` and Sections 1, 2, 3, 5, 6, 7, 8, 9, and 10. Section 4, the one-anchor rigidity proof, is unchanged. Later branch commits are control/profile metadata only unless a new mathematical disposition says otherwise.

No independent audit or clean-build PASS is claimed for this exact new source. Remote workflows remain manual-only and were not dispatched for this rewrite.
...
The next permissible product action is one independent mathematical/source review of exact manuscript checkpoint `f6a3d388...`, including a clean compile. The review should especially check:
